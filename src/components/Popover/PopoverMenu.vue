<template>
  ...
  >
    <div class="px-3 py-2 bg-gray-100 border-b border-gray-200 rounded-t-lg">
      <h3 class="font-semibold text-gray-900">Kabin ve yolcu secimi</h3>
    </div>
    <div class="px-3 py-2 flex flex-col items-center justify-around">
      <div class="flex space-x-6">
        <div class="flex items-center">
          ...
          />
          <label for="default-radio-1" class="ml-2 text-sm font-normal text-gray-900">Economy Class</label>
        </div>
        <div class="flex items-center">
          <input
            id="default-radio-2"
            ...
            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500"
          />
          <label for="default-radio-2" class="ml-2 text-sm font-normal text-gray-900">Business Class</label>
        </div>
      </div>
      <div class="flex justify-around items-center w-full mt-4">
        ...
        <div class="flex items-center space-x-4">
          <button
            type="button"
            class="text-white bg-slate-400 hover:bg-slate-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
